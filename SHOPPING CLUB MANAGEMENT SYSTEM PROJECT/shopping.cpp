...
int main()
{
     ...
     for(int i=0;i<=51;i++)
     {
		...
		system("color F2");     //  for console color
	gotoxy(17,5);
	cout<<"-----------------------------------------------------------"<<endl;
	gotoxy(17,7);
	cout<<"||            Shopping Club Management System                ||"<<endl;
	gotoxy(17,9);
	cout<<"-----------------------------------------------------------"<<endl;
   	gotoxy(17,11);
   	cout<<"|Subject Teacher ->> DHANALEKSHMI MAM & VIKASH SIR <<-- |\n"<<endl;
   	gotoxy(17,13);
   	cout<<">>>----Project Implemented By-----<<<"<<endl;
    gotoxy(22,15);
   	cout<<"CHIRAG SHARMA(LATG10024)"<<endl;
   	gotoxy(22,16);
   	cout<<"PRAKHAR JAIN(LATG10025)"<<endl;
   	gotoxy(22,17);
   	cout<<"ARYAN GARG(LATG10046)"<<endl<<endl;
	system("pause");
	system("cls");
	system("color Fc"); 
